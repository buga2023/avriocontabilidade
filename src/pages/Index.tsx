...
const AdvantagesSection = React.lazy(() => 
  import('@/components/sections/AdvantagesSection').then(module => ({ default: module.AdvantagesSection }))
);
const ClientsSection = React.lazy(() => 
  import('@/components/sections/ClientsSection').then(module => ({ default: module.ClientsSection }))
);
const ClientPlatformSection = React.lazy(() => 
  import('@/components/sections/ClientPlatformSection').then(module => ({ default: module.default }))
);
const BusinessServicesSection = React.lazy(() => 
  import('@/components/sections/BusinessServicesSection').then(module => ({ default: module.BusinessServicesSection }))
);
const MeiParaMeSection = React.lazy(() => 
  import('@/components/sections/MeiParaMeSection').then(module => ({ default: module.MeiParaMeSection }))
);
const TestimonialsSection = React.lazy(() => 
  import('@/components/sections/TestimonialsSection').then(module => ({ default: module.TestimonialsSection }))
);
const FreeBusinessOpeningSection = React.lazy(() => 
  import('@/components/sections/FreeBusinessOpeningSection').then(module => ({ default: module.FreeBusinessOpeningSection }))
);
